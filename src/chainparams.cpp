...
{
    const char* pszTimestamp = "NY Times 06/Feb/2018 Falcon Heavy Carries SpaceX’s Ambition Into Orbit";
...
public:
    CMainParams() {
        ...
        checkpointData = (CCheckpointData) {
            {
                {1, uint256S("0x234ab0117eaef3b6c950ebd5fb66b8c8fde022943da617e493b51c9b6591b7b6")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1522545042, 293345, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1522545042, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
