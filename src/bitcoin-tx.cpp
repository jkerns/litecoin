...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s nebulacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  nebulacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nebulacoin transaction") + "\n" +
              "  nebulacoin-tx [options] -create [commands]   " + _("Create hex-encoded nebulacoin transaction") + "\n" +
              "\n";
